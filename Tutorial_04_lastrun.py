...
expName = 'Tutorial_04'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\HILONI SHAH\\Downloads\\Tutorial_04_lastrun.py',
...
trials = data.TrialHandler(nReps=24.0, method='sequential', 
    ...
    trialList=data.importConditions('sequence_condition (1).xlsx'),
...
trials_2 = data.TrialHandler(nReps=24.0, method='fullRandom', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('C:/Users/HILONI SHAH/Downloads/sequence_condition.xlsx'),
